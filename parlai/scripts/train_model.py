...
class TrainLoop():
    def __init__(self, opt):
        ...
        self.test_world = None  # added by HengyiCai
        self.opt = opt
    ...
    # --------------- change by hengyicai -------------------------
    def return_teacher_agent(self):
        # Return the teacher_agent used in this training loop.
        # Warning: This may only behaves well for BatchWord and DialogPartnerWorld.
        if hasattr(self.world, 'world') and hasattr(self.world.world, 'agents'):
            maybe_dialog_partner_agents = self.world.world.agents
            if len(maybe_dialog_partner_agents) == 2:
                task_agent = maybe_dialog_partner_agents[0]
                if hasattr(task_agent, 'receive_metrics'):
                    return task_agent
        return None
    # --------------- change by hengyicai -------------------------
