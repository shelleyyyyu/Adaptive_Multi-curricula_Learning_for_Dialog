...
export CUDA_VISIBLE_DEVICES=0 train_model seq2seq personachat_h3_dynamic_kmeans combine_v1 11000 -1 0.2 50
export CUDA_VISIBLE_DEVICES=0 train_model seq2seq personachat_h3_dynamic_kmeans combine_v2 11000 -1 0.2 50
export CUDA_VISIBLE_DEVICES=1 train_model seq2seq personachat_h3_dynamic_kmeans combine_v3 11000 -1 0.2 50
export CUDA_VISIBLE_DEVICES=1 train_model seq2seq personachat_h3_dynamic_kmeans combine_v4 11000 -1 0.2 50
export CUDA_VISIBLE_DEVICES=0 train_model seq2seq personachat_h3_dynamic_kmeans combine_v5 11000 -1 0.2 50
