...
function train_model() {
  ...
  local model_dir=./models_daily/adaptive_learning_v${FLAG}/"$(hostname)"_gpu${CUDA_VISIBLE_DEVICES}/${model_name}/${task_name}/${real_attr}
...
export CUDA_VISIBLE_DEVICES=0; train_model transformer personachat_h3_dynamic_daily combine_hdbscan_w2v_daily_8 11000 -1 0.2 30