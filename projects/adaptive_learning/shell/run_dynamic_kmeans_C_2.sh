...
declare -A subtasks_list=(
  ...
  ["combine_v14"]="kmeans_keyword_tfidf_C_2_5:0:4"
)
...
function train_model() {
  ...
  local model_dir=./models_keyword/adaptive_learning_v${FLAG}/"$(hostname)"_gpu${CUDA_VISIBLE_DEVICES}/${model_name}/${task_name}/${real_attr}
...
export CUDA_VISIBLE_DEVICES=1; train_model seq2seq personachat_h3_dynamic_kmeans combine_v14 11000 -1 0.5 60