...
function train_model() {
  ...
  local model_dir=./models_dynamic_kmeans_loss/adaptive_learning_v${FLAG}/"$(hostname)"_gpu${CUDA_VISIBLE_DEVICES}/${model_name}/${task_name}/${real_attr}
...
export CUDA_VISIBLE_DEVICES=1; train_model seq2seq personachat_h3_dynamic_kmeans combine_kmeans_w2v_1000 11000 -1 0.2 30  0.5 0.05