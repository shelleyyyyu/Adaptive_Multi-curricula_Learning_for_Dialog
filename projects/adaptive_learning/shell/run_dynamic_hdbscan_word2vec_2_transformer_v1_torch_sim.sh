...
function train_model() {
  ...
  local model_dir=./models_dynamic_hdbscan_transformer_v1_torchsim/adaptive_learning_v${FLAG}/"$(hostname)"_gpu${CUDA_VISIBLE_DEVICES}/${model_name}/${task_name}/${real_attr}
