...
function train_model() {
  ...
  local model_dir=./models_open/adaptive_learning_v${FLAG}/"$(hostname)"_gpu${CUDA_VISIBLE_DEVICES}/${model_name}/${task_name}/${real_attr}
...
export CUDA_VISIBLE_DEVICES=1; train_model transformer personachat_h3_dynamic_open combine_hdbscan_w2v_open_4 11000 -1 0.2 30